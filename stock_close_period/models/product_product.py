...
class Product(models.Model):
    ...
    def _compute_quantities_available(self, to_date=False):
        ...
        self.env.cr.execute(query_quants, param_quants)
        ...
        self.env.cr.execute(query_moves_plus, param_moves_plus)
        ...
        self.env.cr.execute(query_moves_minus, param_moves_minus)
        for row in self._cr.fetchall():
            move_qty = row[0]
            product_id = row[1]
